...
export default function useBookings({
    ...
    services,
    type = "booking",
    mode = "all", // 👈 NEW: "all", "pending", "arrived"
    initialPage = 1,
    pageSize = 25,
    sortBy = "createdDate",
    sortDir,
    ...
    const fetchBookings = useCallback(async () => {
        ...
        try {
            ...
            if (mode === "arrived") {
                // 👇 use new API
                res = await BookingApi.getArrivedBookings({
                    page,
                    limit: pageSize,
                    sortBy,
                    sortDir,
                ...
                // 👇 reuse status param to call /bookings with pending
                res = await BookingApi.getBookings({
                    page,
                    limit: pageSize,
                    sortBy,
                    sortDir,
